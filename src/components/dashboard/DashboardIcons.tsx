...
function stroke(color: string, strokeWidth = 2) {
  return {
    stroke: color,
    strokeWidth,
...
export function ChartColumnsIcon({
  size = 18,
  color = '#1F5D4E',
  strokeWidth = 2,
}: IconProps) {
...
export function CheckinTabIcon({
  size = 20,
  color = '#1F5D4E',
  strokeWidth = 2,
}: IconProps) {
...
export function HouseIcon({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z" {...s} />
    </Svg>
  );
}
...
export function TabIcon({
  ...
  switch (name) {
    ...
    case 'coach':
      return (
        <MessageSquareIcon size={size} color={color} strokeWidth={strokeWidth} />
      );
    case 'explore':
