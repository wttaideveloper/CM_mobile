...
import { BIZ_LIST_GREEN } from '@/components/market/marketBusinessListData';
...
type MarketBusinessListHeaderProps = {
  count: number;
};

export function MarketBusinessListHeader({
  count,
}: MarketBusinessListHeaderProps) {
  ...
  return (
    <View style={styles.header}>
      ...
      <Text style={styles.count}>{count} businesses nearby</Text>
    </View>
  );
}
...
const styles = StyleSheet.create({
  header: {
    backgroundColor: BIZ_LIST_GREEN,
