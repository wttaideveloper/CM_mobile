...
import { MARKET_CHECKOUT_GREEN } from '@/components/market/marketCheckoutData';
...
export function MarketCheckoutHeader() {
    ...
    <View style={styles.header}>
      ...
      <View style={styles.topRow}>
        ...
        <View style={styles.titleBlock}>
          <Text style={styles.eyebrow}>Step 2 of 2 · Payment</Text>
