...
import { canCopyMessage, canDownloadAttachment } from '@/utils/chatMessage';
...
export function ChatMessageItem({
    ...
    return (
      <View style={styles.systemRow}>
        <View style={[styles.systemBubble, message.isArchived && styles.archivedBubble]}>
          <Text style={styles.systemText}>{sanitizeChatText(message.text ?? '')}</Text>
        </View>
      </View>
    );
  }
  ...
  const canDownload = canDownloadAttachment(message);
              ...
              {message.voice?.transcript && message.voice.transcript !== 'Voice message' ? (
                <View style={styles.transcriptBox}>
                  ...
                  <Text style={[styles.transcriptText, isUser && styles.transcriptTextUser]}>
                    {sanitizeChatText(message.voice.transcript)}
                  </Text>
                </View>
              ) : null}
            </>
